...
export class ClineProvider extends EventEmitter<ClineProviderEvents> implements vscode.WebviewViewProvider {
	public static readonly sideBarId = "wizee.SidebarProvider" // used in package.json as the view's id. This value cannot be changed due to how vscode caches views based on their id, and updating the id would break existing instances of the extension.
	public static readonly tabPanelId = "wizee.TabPanelProvider"
	...
	*/
	...
	public static async getInstance(): Promise<ClineProvider | undefined> {
		...
		if (!visibleProvider) {
			await vscode.commands.executeCommand("wizee.SidebarProvider.focus")
	...
	async getStateToPostToWebview() {
		...
		const allowedCommands = vscode.workspace.getConfiguration("wizee").get<string[]>("allowedCommands") || []
		const cwd = this.cwd
